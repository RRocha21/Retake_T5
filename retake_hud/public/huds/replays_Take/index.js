    ...
    if (phase) {
        ...
        if (phase.phase == "live" && phase.phase !== "bomb") {
            if (phase.phase_ends_in > 104) {
                if ($(".Top_Bar>.Team_A>.Top_BG>.Team_A_Name").css("opacity") == 0 && $(".Top_Bar>.Team_B>.Top_BG>.Team_B_Name").css("opacity") == 0) {
                    showTeamName();
                }
            } else {
                if ($(".Top_Bar>.Team_A>.Top_BG>.Team_A_Name").css("opacity") == 1 && $(".Top_Bar>.Team_B>.Top_BG>.Team_B_Name").css("opacity") == 1) {
                    if (data.info.bomb.state !== "planting") {
                        hideTeamName();
                    }
                }
